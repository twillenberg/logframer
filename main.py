...
# Define the high-level statements for the log frame.
lf.set_impact("The GIRoA can effectively manage resources in support of economic growth and to improve the lives of the Afghan people.")

# Define the high-level indicators for the log frame.
imp_ind = Indicator(1, "GDP Growth", 0, 5)
lf.impact.add_indicator(imp_ind)

lf.set_outcome("Transparent and well functioning GIRoA budget process.")
# Define the high-level indicators for the log frame.
oc_ind = Indicator(2, "Transparency Index", 21, 27)
lf.outcome.add_indicator(oc_ind)

# Add assumptions for the log frame.
...
lf.impact.add_assumption(impact_assumption1)
lf.outcome.add_assumption(outcome_assumption1)
...
lf.display_impact()
lf.impact.number_of_assumptions()
lf.impact.display_assumptions()
lf.separate()

lf.display_outcome()
lf.outcome.number_of_assumptions()
lf.outcome.display_assumptions()
lf.separate()
